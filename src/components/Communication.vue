<template>
    <section class="communication_area">
        ...
        <p class="title">Хэрэв таньд <br/>
            <span class="communication-section__title--highlight">асууж лавлах зүйл байвал</span>
        </p>
        <div class="user_list">
            <h3>Нөхрийн тал</h3>
            <ul>
...
export default {
    setup () {
        const groomSide = ref([
            {title: 'Раднаабазар', name: 'Мөнхбат', phone: '80106666'},
            // {title: 'Раднаабазар', name: 'Мөнхжаргал', phone: '010-5247-9572'},
            // {title: 'Ариу', name: '김유미', phone: '010-3317-0434'},
        ]);

        const brideSide = ref([
            {title: 'Соронзонболд', name: 'Азжаргал', phone: '99050130'},
